...
public class SpecificationBuilder {
    ...
    public Specification<Comment> getSpecificationSelectCommentByParams(QueryParams queryParams) {
    ...
    private Specification<Comment> getNewsIdSpecification(QueryParams queryParams) {
    ...
    private Specification<Comment> getUserIdSpecification(QueryParams queryParams) {
        return (root, query, cb) -> {
    ...
    private Specification<Comment> getTextSpec(QueryParams queryParams) {
        return (root, query, cb) -> {
