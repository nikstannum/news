...
//import ru.clevertec.service.dto.ClientUserReadDto.UserReadRoleDto;
...
//        ClientUserReadDto expected = getStandardUserDto(1L);
...
//    }
//
//    private ClientUserReadDto getStandardUserDto(Long id) {
//        ClientUserReadDto dto = new ClientUserReadDto();
//        dto.setId(id);
...
//        Mockito.doReturn(expected).when(mapper).convert(user);
//
//        ClientUserReadDto actual = service.findByEmail(user.getEmail());
//
...
//        ClientUserReadDto readDto = getStandardUserDto(1L);
//        Mockito.doReturn(readDto).when(mapper).convert(expected);
//
//        ClientUserReadDto actual = service.create(createUpdateDto);
//
...
//        Mockito.doReturn(expected).when(mapper).convert(user);
//
//        ClientUserReadDto actual = service.update(1L, createUpdateDto);
//
//        assertThat(actual).isEqualTo(expected);
//    }
//
