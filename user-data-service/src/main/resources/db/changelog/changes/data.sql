...
VALUES
	('Nick', 'Johnson', 'admin@admin.ru', '$2a$10$O.F1CwjVoKO.CsY5p1laee2V5vgsVOPqPlDyxjg1bF9epsIFqWD0u', (SELECT r.role_id FROM roles r WHERE r."name" = 'ADMIN')),
	('Mike', 'Scholz', 'journalist@journalist.ru', '$2a$10$O.F1CwjVoKO.CsY5p1laee2V5vgsVOPqPlDyxjg1bF9epsIFqWD0u', (SELECT r.role_id FROM roles r WHERE r."name" = 'JOURNALIST')),
	...
	('Yuri', 'Ivanov', 'subscriber@subscriber.ru', '$2a$10$O.F1CwjVoKO.CsY5p1laee2V5vgsVOPqPlDyxjg1bF9epsIFqWD0u', (SELECT r.role_id FROM roles r WHERE r."name" = 'SUBSCRIBER')),
